...
// 
//
// Related Topics Array Hash Table Math Design Randomized 👍 9037 👎 589
...
public class RandomizedSet {
    ...
    {
        _dictionary = new Dictionary<int, bool>();
    }
    ...
    public int GetRandom()
    {
        ...
        var randomIndex = random.Next(dictionaryCount);
        
        return _dictionary.ElementAt(randomIndex).Key;
    }
}
